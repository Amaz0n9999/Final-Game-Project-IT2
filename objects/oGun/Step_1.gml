...
if (global.glockgun == false)
{
	...
	{
		if (image_angle > 90) && (image_angle < 180) or (image_angle > 180) &&  (image_angle < 270)
		{
		    gunkickx = 0;
			gunkicky = 0;
		}
